...
rk45: $\mathbb{R}^n \times \mathbb{R}^n \times (\mathbb{R} \times \mathbb{R}^n 
\times \mathbb{R}^n) \rightarrow (\mathbb{R}^n)^k$\\
rk45($karray$, ${\bf x}_k$, ${\bf f}$) $\equiv$ $result : (\forall k | k 
\in karray : result_i = evalrk45 (k_i,h, {\bf x}_k, {\bf f}))$ \\
