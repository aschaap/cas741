...
The structure of this documents is based on \cite{Smith2006}.
\section{Plan}
...
assessment of the generated code will be required. To make this easier, 
generating readable code is desirable. The manual assessment should determine 
