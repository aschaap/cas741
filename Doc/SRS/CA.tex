...
second (\iref{T_RK4}) and fourth (\iref{IM_RK2}) order RK methods will be used. 
\wss{This is a
...
\wss{The assumptions don't
  need to repeat things you have alread said.} \als{Removed this.}
...
%size (\ddref{DD_stepsize}) shall be a positive real number. 
  ...
  information.} \als{I've removed this as well.}
\end{itemize}
