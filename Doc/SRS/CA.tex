...
instance models in \nameref{sec_Calculation}. Every unique input will 
...
this definition to compare their overlapping but slightly differing 
viewpoints.}. After instance models, the lack of variability in output is 
covered.
