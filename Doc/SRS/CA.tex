...
$h$ & N/A & step size
\\ 
$t$ & N/A & an independent variable, perhaps easy to think of as time
\\ 
...
\\ 
$k_{1..4}, {\bf Y}_1$ & N/A & intermediate variables in the RK methods
\\ 
\bottomrule
\end{longtable*}
...
instance models in \autoref{ssec:instance_models}. Every unique input will 
...
interval's bounds (\ddref{DD_interval}) satisfy $t_0 < t_N$.
