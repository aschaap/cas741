...
MetaOCaml by Dr. J. Carette. \wss{put a slash (or tilde) after the period to get the
    spacing right. That is, it should be Dr.\ J.\ Carette.  Otherwise LaTeX
    interprets a period as the end of a sentence and leaves two spaces.}
...
\wss{Please format your tex file with 80 width lines of text, with a hard return at the
  end of each line.}
